// U. Dammer. Version 1.9 Liestal  14.12.2023
...
fillRectRounded(x, y, width, height, radius)	// gefülltes Rechteck mit abgerundeten Ecken von Mathieu Cottet
weitere abgerundete und drehbare Rechtecke siehe unten (M.C.)
...
function baseFillRectRotate(x, y, x1, y1, width, height, alpha) {			//M.C.
	ctx.save();
	ctx.translate(x,y);	
...
function fillRectRotate(x,y,width,height,alpha){	
	baseFillRectRotate(x, y, 0, 0, width, height, alpha);				//M.C.				
}

function baseRectRounded(x, y, width, height,r) {						//M.C.
	ctx.beginPath();
...
function fillRectRounded(x, y, width, height, r) {					//M.C.
	baseRectRounded(x, y, width, height, r);
}

function fillRectRoundedCenterRotate(x, y, width, height, r, alpha) {		//M.C.
	ctx.save();
	ctx.translate(x,y);	
	ctx.rotate(alpha*Math.PI/180);
...
function fillRectRoundedRotate(x, y, width, height, r, alpha) {				//M.C.
	ctx.save();
	ctx.translate(x,y);	
	ctx.rotate(alpha*Math.PI/180);
